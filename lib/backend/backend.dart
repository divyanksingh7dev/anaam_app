...
import 'schema/activity_info_record.dart';
...
export 'schema/activity_info_record.dart';
...
/// Functions to query ActivityInfoRecords (as a Stream and as a Future).
Stream<List<ActivityInfoRecord>> queryActivityInfoRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
    queryCollection(
      ActivityInfoRecord.collection,
...
Future<List<ActivityInfoRecord>> queryActivityInfoRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
...
Future<FFFirestorePage<ActivityInfoRecord>> queryActivityInfoRecordPage({
  Query Function(Query)? queryBuilder,
  DocumentSnapshot? nextPageMarker,
  required int pageSize,
  required bool isStream,
